...
if __name__ == "__main__":
    ...
    if filtered_logs:
        ...
        # 최근 일주일간의 사용 시간을 화면에 표시
        today = datetime.today().date()
        one_week_ago = today - timedelta(days=6)  # 오늘을 포함한 최근 7일
        print("\nDaily Usage Times - Last 7 Days:")
        for date in (one_week_ago + timedelta(days=i) for i in range(7)):
            hours = daily_usage[date]
